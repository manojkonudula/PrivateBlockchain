...
export PEER0_HOSPITAL_CA=${PWD}/organizations/peerOrganizations/hospital/peers/peer0.hospital/tls/ca.crt
export PEER0_PHARMACY_CA=${PWD}/organizations/peerOrganizations/pharmacy/peers/peer0.pharmacy/tls/ca.crt
export PEER0_LABORATORY_CA=${PWD}/organizations/peerOrganizations/laboratory/peers/peer0.laboratory/tls/ca.crt
...
setGlobals() {
  ...
  elif [ "$USING_ORG" == "laboratory" ]; then
...
setGlobalsCLI() {
  ...
  if [ "$USING_ORG" == "hospital" ]; then
    ...
    export CORE_PEER_ADDRESS=peer0.pharmacy:5555
  elif [ "$USING_ORG" == "laboratory" ]; then
    export CORE_PEER_ADDRESS=peer0.laboratory:6666
