...
const HealthRecords = (args) => {
  ...
  const handleSubmit = async (e) => {
    ...
    var data = {
      ...
      insuranceInfo: e.target.insurance_info.value,
      isPrivate: true
    }
      ...
      <div className='p-2 ml-0 sm:ml-4 min-w-full  border rounded-md mb-4'>
        <div className='flex-row md:flex pb-4 break-words'>
          <div className='w-full md:w-[50%] mr-2'>
            ...
            <div className='grid mb-2'>
              <label className='pl-2 font-medium'>Allergies:</label>
              <div className='px-4 py-2 border border-gray-500 rounded'>{healthRecord.allergies}</div>
            </div>
          </div>
          <div className='w-full md:w-[50%] md:ml-2'>
            ...
            <div className='grid mb-2'>
              <label className='pl-2 font-medium'>Insurance and payment information:</label>
              <div className='px-4 py-2 border border-gray-500 rounded'>{healthRecord.insuranceInfo}</div>
            </div>
          </div>
        </div>
      ...
      <div className='p-2 ml-0 sm:ml-4 min-w-full border rounded-md mb-4'>
        <form onSubmit={handleSubmit}>
          ...
          <div className='py-4 pl-4'>
            ...
            ${isLoading ? 'bg-blue-200 cursor-wait' : ''}`}>
              Save
            </button>
          </div>
        </form>
