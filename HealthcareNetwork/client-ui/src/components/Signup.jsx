...
const Signup = (props) => {
    ...
    return (
        <div className="bg-gray-100 min-w-full flex flex-col justify-center py-6 sm:px-6 lg:px-8">
            ...
            <form className="space-y-4 px-2" onSubmit={handleSignup}>
                ...
                <div>
                    ...
                    leading-tight focus:outline-none focus:shadow-outline" id="confirmPassword"
                ...
                <div>
                    ...
                    <input required className="border rounded w-full py-2 px-3 
                    text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="mobile" type="text" placeholder="Mobile Number" />
                </div>
                <div>
